...
\begin{figure}[h!]
  \caption{Hemoglobin.}\label{fig:hemoglobin}
  \centering
    \includegraphics[width=\textwidth]{Chapter2/Figs/globin.eps}
\end{figure}

\begin{figure}[h!]
  \caption{Melanin.}\label{fig:melanin}
  \centering
    \includegraphics[width=\textwidth]{Chapter2/Figs/melanin.eps}
\end{figure}
