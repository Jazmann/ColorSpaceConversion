...
\begin{figure}[h!]\label{fig:YABCubeEval}
  \centering
    \includegraphics[width=\textwidth]{Chapter2/Figs/YABCubeEval.eps}
    \caption{Evaluation of the color space problem.}
\end{figure}
...
\begin{figure}[h!]
  ...
  \centering
    ...
    \caption{Human eye representation of the color spectrum.}
\end{figure}
...
\begin{figure}[h!]
  ...
  \centering
    ...
    \caption{Oxy-hemoglobin, deoxy-hemoglobin and melanin absorption characteristics.}
\end{figure}
...
\begin{figure}[h!]
  ...
  \centering
    ...
    \caption{Oxy-hemoglobin, deoxy-hemoglobin and melanin scattering spectra.}
\end{figure}
...
\begin{figure}[h!]
  \label{fig:colorBasis}
  \centering
    \includegraphics[width=\textwidth]{Chapter2/Figs/colorBasis.eps}
    \caption{Final skin chromophore positions.}
\end{figure}
