...
OpenCV provides several edge detection methods to suit a range of static and realtime feature detection applications. However, none are quite as effective for the purposes of this project as the Canny edge detector.
