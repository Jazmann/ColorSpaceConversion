...
\begin{figure}[h!]
  \centering
    ...
    \caption{Still images from a video taken with an iPhone. From left to right: original; rotated luminosity channel; rotated chromatic channel x; rotated chromatic channel y.}  \label{fig:pressureCandidates1}
\end{figure}

\begin{figure}[h!]
  \centering
    \includegraphics[width=\textwidth]{Chapter3/Figs/fingerPressureRotatedScaled.eps}
    \caption{Still images from a video taken with an iPhone. From left to right: original; rotated and scaled luminosity channel; rotated and scaled chromatic channel x; rotated and scaled chromatic channel y.}  \label{fig:pressureCandidates2}
\end{figure}

\begin{figure}[h!]
  \centering
    \includegraphics[width=\textwidth]{Chapter3/Figs/fingerPressureRotatedCompactScaled.eps}
    \caption{Still images from a video taken with an iPhone. From left to right: original; rotated, compacted and scaled luminosity channel; rotated, compacted and scaled chromatic channel x; rotated, compacted and scaled chromatic channel y.}  \label{fig:pressureCandidate3}
\end{figure}
