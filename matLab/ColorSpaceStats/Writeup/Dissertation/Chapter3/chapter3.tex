...
OpenCV provides several methods for edge detection to suit a range of static and realtime feature detection applications.

\subsection{Canny}\label{sec:Canny}

\subsection{Sobel}\label{sec:Sobel}

\subsection{Harris}\label{sec:Harris}

\subsection{Hough}\label{sec:Hough}
