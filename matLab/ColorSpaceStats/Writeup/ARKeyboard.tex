...
\frac{dRange}{sRange L(\theta)} \Delta \le 1
\end{equation}

Where $dRange$ is the number of values which the destination type can contain, and $sRange$ is the number of values the RGB source type can contain.
