...
\begin{equation}\label{ErfDefinition}
  \int _{\text{sMin}}^{\text{sMax}}\frac{A\left\backslash e^{-\frac{t^2}{2}}\right.}{\sqrt{2\backslash \pi }}dt=\frac{1}{2} A \left(\text{erf}\left(\frac{\text{sMax}-\mu }{\sqrt{2} \sigma }\right)-\text{erf}\left(\frac{\text{sMin}-\mu }{\sqrt{2} \sigma }\right)\right)
\end{equation}
