...
\begin{equation}
\Delta = \frac{\text{dMax - dMin}}{\text{sMax - sMin}} \frac{\sqrt{\frac{2}{\pi }}}{\sigma  \left(\text{erf}\left(\frac{\mu }{\sqrt{2} \sigma }\right)-\text{erf}\left(\frac{\mu -1}{\sqrt{2} \sigma }\right)\right)}
\end{equation}

therefore the required fidelity in the source domain is given by $\frac{1}{\Delta}$.
