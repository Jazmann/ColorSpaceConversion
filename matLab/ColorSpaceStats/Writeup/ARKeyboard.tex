...
\begin{equation}
 \frac{\text{erf}\left(\frac{\mu }{\sqrt{2} \sigma }\right)+\text{erf}\left(\frac{x-\mu }{\sqrt{2} \sigma }\right)}{\text{erf}\left(\frac{\mu }{\sqrt{2} \sigma }\right)-\text{erf}\left(\frac{\mu -1}{\sqrt{2} \sigma }\right)}=\text{dL} \quad \text{where} \quad dL = \left\{ \frac{1}{dMax - dMin}, 1 - \frac{1}{dMax - dMin} \right\}
\end{equation}
...
The next number we need is where one unit change in the source produces one unit change in the destination.
