...
Given that we are free to choose the orientation of the color space about the luminosity axis, the Matlab code allows us to find an orientation of the color space about the luminosity axis in which the distribution can be expressed as a product of 1-dimensional Gaussians. The final resulting distribution is presented in Figure~\ref{fig:ColorSpaceOrientation}.

\begin{figure}[h!]
  \caption{Color space orientation.}
  \label{fig:ColorSpaceOrientation}
  \centering
...
\begin{figure}[h!]
  \caption{Convergence of the skin space.}
  \centering
