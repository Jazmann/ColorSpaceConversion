...
\section{Constant patterns under mechanical stresses in the hand}
\section{Dynamic patterns under mechanical stresses in the hand}
\subsection{Finger pad pressure}
\subsection{Fingernail pressure} 
\section{Pattern recognition techniques in opencv}
\section{Implementation of pattern recognition using opencv on an iPhone}

\section{Refining the target area for search}
\subsection{Blob detection}
\subsection{Hand posture prediction}
\subsection{Dynamic tracking}
\chapter{The fingertip mechanical stress detection app}
\section{Opencv integration with  iOS}
\subsection{C++11 and opencv}
\subsection{Integrating C++11,openCV and iOS data types}
\subsection{Using parallel processing in openCV and iOS}
\subsection{Implementing working data types efficiently in openCV}
\section{Dynamic vs. Static statistics}
\subsection{Color-space dynamically updated statistics}
\subsection{Updating the pattern recognition model for specific individuals}
\subsection{Updating the mechanical stress models to account for environment}
\section{Balancing the processor load}
\subsection{Frame-rate capture vs. frame processing rate}
\subsection{Background processes}
\subsection{Updating the hand posture model}
\subsection{Updating the color-space model}
\subsection{Updating the scene background model}
