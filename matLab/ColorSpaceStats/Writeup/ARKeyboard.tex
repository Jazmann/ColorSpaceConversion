...
\begin{figure}[h!]
  ...
  \centering
    \includegraphics[width=\textwidth]{pressureCandidates.eps}
\end{figure}
\begin{figure}[h!]
  ...
  \centering
    \includegraphics[width=\textwidth]{fingerPressureRotated.eps}
\end{figure}
\begin{figure}[h!]
  ...
  \centering
    \includegraphics[width=\textwidth]{fingerPressureRotatedScaled.eps}
\end{figure}
\begin{figure}[h!]
  ...
  \centering
    \includegraphics[width=\textwidth]{fingerPressureRotatedCompactScaled.eps}
\end{figure}
