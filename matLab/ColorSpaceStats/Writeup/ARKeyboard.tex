...
\begin{equation}\label{eq:CompressedRotation}
 \widetilde{R}_{xyz}(\theta,\mathbf{\mu},\mathbf{\sigma}) = \left(
\begin{array}{ccc}
 \frac{1}{\sqrt{3}} & \frac{1}{\sqrt{3}} & \frac{1}{\sqrt{3}} \\
 \kappa \Lambda(\mu_2,\sigma_2) \left(-\frac{\cos (\theta )}{\sqrt{6}}-\frac{\sin (\theta )}{\sqrt{2}}\right) & 
 \kappa \Lambda(\mu_2,\sigma_2) \sqrt{\frac{2}{3}} \cos (\theta ) & 
 \kappa \Lambda(\mu_2,\sigma_2) \left(\frac{\sin (\theta )}{\sqrt{2}}-\frac{\cos (\theta )}{\sqrt{6}}\right) \\
 \kappa \Lambda(\mu_3,\sigma_3) \left(\frac{\sin (\theta )}{\sqrt{6}}-\frac{\cos (\theta )}{\sqrt{2}}\right) & 
 - \kappa \Lambda(\mu_3,\sigma_3) \sqrt{\frac{2}{3}} \sin (\theta ) & 
 \kappa \Lambda(\mu_3,\sigma_3) \left(\frac{\cos (\theta )}{\sqrt{2}}+\frac{\sin (\theta )}{\sqrt{6}}\right) \\
\end{array}
\right)
\end{equation}
...
\begin{array}{ccc}
 \frac{1}{3} & \frac{1}{3} & \frac{1}{3} \\
  \frac{\text{rgbRange} }{dRange} \Lambda(\mu_2,\sigma_2)\left(-\frac{\cos (\theta )}{2}-\frac{1}{2} \sqrt{3} \sin (\theta )\right) & \frac{\text{rgbRange} }{dRange} \Lambda(\mu_2,\sigma_2)\cos (\theta ) & \frac{\text{rgbRange} }{dRange} \Lambda(\mu_2,\sigma_2)\left(\frac{1}{2} \sqrt{3} \sin (\theta )-\frac{\cos (\theta )}{2}\right) \\
 \frac{\sin (\theta )}{2}-\frac{1}{2} \sqrt{3} \cos (\theta ) & -\sin (\theta ) & \frac{1}{2} \sqrt{3} \cos (\theta )+\frac{\sin (\theta )}{2} \\
\end{array}
\right)
\end{equation}
